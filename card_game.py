...
class CardGame(tk.Frame):
    def __init__(self, root, controller):
        ...
        self.back_button = tk.Button(root, text="Back", command=lambda: controller.show_start_page(), bg="white",
                                     fg="black",
                                     font=("Comic Sans MS", 10))
        self.back_button.place(x=20, y=20)
        self.back_button.config(activebackground="#E2E1E0")
...
class StartPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        button1 = tk.Button(self.canvas, text="Screw Now", command=lambda: controller.show_card_game(), bg="#E3BA5C",
                            fg="white", font=("Comic Sans MS", 14))
        button1.place(x=470, y=600, width=240, height=60)
        button1.config(activebackground="#E5A82E")

        button2 = tk.Button(self.canvas, text="How to Play", command=lambda: controller.show_how_to_play(), bg="white",
...
class HowToPlayPage(tk.Frame):
    def __init__(self, parent, controller):
        ...
        # Back button
        button = tk.Button(self.canvas, text="Back", command=lambda: controller.show_start_page(),
